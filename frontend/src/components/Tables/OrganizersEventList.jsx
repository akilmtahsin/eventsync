...
export function OrganizerEventList() {
  ...
  <div className="mb-4.5 flex flex-col gap-6">
    <div className="w-full">
      <label className="mb-2.5 block text-black dark:text-white">Event Type</label>
      <select
        className="w-full rounded border-[1.5px] border-solid bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-red-600 disabled:cursor-default disabled:bg-white"
      >
...
<div className="p-6.5">
  <div className="mb-4.5 flex flex-col gap-6">
  <div className="w-full">
          <label className="mb-2.5 block text-black dark:text-white">Paid or Unpaid</label>
          <select
            className="w-full rounded border-[1.5px] border-solid bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-red-600 disabled:cursor-default disabled:bg-white"
        ...
        {paymentStatus === 'paid' && (
          <div className="w-full">
            <label className="mb-2.5 block text-black dark:text-white">Payment Amount</label>
            <input
              type="text"
            ...
            <table className="min-w-full text-left text-sm font-light">
              ...
              <tbody>
                <tr className="border-b dark:border-neutral-500">
                  ...
                  <td className="whitespace-nowrap px-6 py-4">{!isPending ? (
                  ...
                  <td className="whitespace-nowrap px-6 py-4">
                  <div className=" max-w-full flex justify-center">
                      <button onClick={handleEventEdit} className="flex gap-x-1 justify-between items-center mr-3 bg-green-800 hover:bg-opacity-90 rounded-full p-2 text-white">
                        <svg
